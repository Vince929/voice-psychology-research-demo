ALTER TABLE collection_records
    ...
    ADD COLUMN audio_filename VARCHAR(255) NOT NULL AFTER audio_path,
    ADD COLUMN audio_content_type VARCHAR(128) NOT NULL AFTER audio_filename,
    ADD COLUMN idempotency_key VARCHAR(128) NOT NULL AFTER audio_content_type,
