...
const styles = StyleSheet.create({
  section: {gap: 16}, titleRow: {flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16}, titleCopy: {flex: 1, gap: 5}, heading: {fontSize: 25, letterSpacing: -0.5, fontWeight: '800', color: '#163C36'}, body: {fontSize: 15, lineHeight: 22, color: '#52706A'}, refreshButton: {paddingHorizontal: 13, paddingVertical: 8, borderWidth: 1, borderColor: '#B6CEC6', borderRadius: 9, backgroundColor: '#F7FBF9'}, refreshButtonText: {fontSize: 14, fontWeight: '700', color: '#1B6559'}, button: {alignItems: 'center', padding: 16, backgroundColor: '#1B6559', borderRadius: 12}, buttonDisabled: {backgroundColor: '#9DB6B0'}, buttonText: {fontWeight: '800', fontSize: 16, color: '#FFFFFF'}, emptyPanel: {padding: 24, borderRadius: 16, borderWidth: 1, borderColor: '#C8D8D2', borderStyle: 'dashed', backgroundColor: '#F7FBF9', gap: 8}, emptyTitle: {fontSize: 17, fontWeight: '800', color: '#163C36'}, empty: {fontSize: 15, lineHeight: 22, color: '#52706A'}, recordCard: {gap: 9, padding: 17, borderRadius: 16, borderLeftWidth: 4, borderLeftColor: '#6FA597', backgroundColor: '#FAFCFB'}, recordTopRow: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12}, recordTitle: {flex: 1, fontSize: 18, fontWeight: '800', color: '#163C36'}, statusPill: {paddingHorizontal: 9, paddingVertical: 5, borderRadius: 8, backgroundColor: '#FFF3D9', fontSize: 12, color: '#8A5A12', fontWeight: '700'}, statusPillCompleted: {backgroundColor: '#E1EEEA', color: '#285C52'}, statusPillFailed: {backgroundColor: '#FBE7E5', color: '#A43F35'}, recordMeta: {fontSize: 14, color: '#52706A'}, errorText: {fontSize: 13, color: '#A43F35'}, actionRow: {flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 3}, actionButton: {paddingHorizontal: 12, paddingVertical: 9, borderRadius: 8, backgroundColor: '#E1EEEA'}, actionButtonDestructive: {backgroundColor: '#FBE7E5'}, actionButtonText: {fontWeight: '700', color: '#1B6559'}, actionButtonTextDestructive: {color: '#A43F35'}, modalBackdrop: {flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(19, 51, 47, 0.36)'}, detailSheet: {maxHeight: '91%', paddingTop: 12, backgroundColor: '#FAFCFB', borderTopLeftRadius: 26, borderTopRightRadius: 26}, detailHeader: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 22, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: '#E2ECE8'}, detailTitle: {fontSize: 17, fontWeight: '800', color: '#163C36'}, backButton: {minWidth: 62, paddingVertical: 8}, backButtonText: {fontSize: 15, fontWeight: '700', color: '#1B6559'}, headerSpacer: {minWidth: 62}, detailContent: {gap: 16, paddingHorizontal: 22, paddingTop: 20, paddingBottom: 36}, detailIdentity: {gap: 5}, detailSubject: {fontSize: 21, fontWeight: '800', color: '#163C36'}, detailStatus: {fontSize: 14, color: '#285C52', fontWeight: '800'}, detailBlock: {gap: 7, paddingTop: 4}, detailHeading: {fontSize: 14, fontWeight: '800', color: '#285C52'}, detailText: {fontSize: 15, lineHeight: 23, color: '#46645E'}, analysisCard: {gap: 8, padding: 16, borderRadius: 14, backgroundColor: '#E8F0EE'}, analysisState: {fontSize: 21, fontWeight: '800', color: '#163C36'}, disclaimer: {fontSize: 13, lineHeight: 20, color: '#7A6652', padding: 12, backgroundColor: '#FFF8EC', borderRadius: 10}, dangerZone: {gap: 10, paddingTop: 14, borderTopWidth: 1, borderTopColor: '#F0D9D5'}, dangerHint: {fontSize: 13, color: '#9B4B43'},
});
